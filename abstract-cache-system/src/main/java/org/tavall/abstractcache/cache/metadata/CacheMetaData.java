...
public final class CacheMetaData implements ICacheStats {
    ...
    /**
     * @return an empty metadata snapshot
     */
    public static CacheMetaData empty() {
        return new CacheMetaData(0, 0, 0);
    }
    ...
    /**
     * Aggregates this snapshot with another cache stats snapshot.
     *
     * @param other other stats snapshot
     * @return combined snapshot
     */
    public CacheMetaData plus(ICacheStats other) {
        if (other == null) {
            return this;
        }
        return new CacheMetaData(
                totalEntries + other.getTotalEntries(),
                validEntries + other.getValidEntries(),
                expiredEntries + other.getExpiredEntries()
        );
    }
