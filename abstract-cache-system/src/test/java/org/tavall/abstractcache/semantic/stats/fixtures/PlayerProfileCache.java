package org.tavall.abstractcache.semantic.stats.fixtures;
...
import org.tavall.abstractcache.cache.metadata.CacheRegistryMetaDataBuilder;
...
public final class PlayerProfileCache
    ...
    public Optional<CacheRegistryMetaData> createCacheRegistryMetaData() {
        CacheRegistryMetaData cacheRegistryMetaData = CacheRegistryMetaData.builder()
                ...
                .distributed(false)
                .profileEnabled(true)
                .ownerModule("abstract-cache-system-test")
                .build();
